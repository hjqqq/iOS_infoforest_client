...
-(ViewModel* ) init 
{
    ...
    if(self) 
    {
        ...
        {
            _centerScreen.y = (_posX + ScreenSize.size.width)/2;
            _centerScreen.x = (_posY + ScreenSize.size.height)/2;
            NSLog(@"I am sideways");
        }
        else{
            _centerScreen.y = (_posX + ScreenSize.size.height)/2;
            _centerScreen.x = (_posY + ScreenSize.size.width)/2;
            NSLog(@"I am right side up!");
